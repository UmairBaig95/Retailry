...
export default function DigitalStore({ data }) {
  return (
    <section className="digitalStore">
      {data.slice(0, -1).map((i, e) => {
        return (
          <div key={i.id} className="bg-color">
            <div className="container digitalStore-container py-5 py-md-5 ">
              ...
              <div className="row ml-1 feature-row ml-md-4 pb-md-5 pl-md-4">
                <div className="digitalStore-grid col-md-8">
                  {i.Detail.map((link, index) => {
                    return (
                      <div
                        key={index}
                        className="card digitalStore-cards pr-3 "
                      >
                ...
                <div className="col-md-4 d-none d-md-block">
                  <img style={{ width: "80%" }} src={i.Image} alt="" />
                </div>
              </div>
            </div>
          </div>
